...
<div class=\"container\" id=\"navfluid\">
    ...
    <li      class=\"dropdown\">
        ...
        <ul class=\"dropdown-menu\">  <li><a href=\"nbnradius_defaultpages.php\">NBN</a></li><li><a href=\"dslradius_defaultpages.php\">DSL</a></li>  
...
<script src=\"jsols/bootstrap.min.js\"></script>
...
<center>
    ...
    <script language=\"JavaScript\">
        ...
        function qsubmitnbnrealm(realm)
        {
        ...
        function submitnbnrealm(realm)
        {
               alert(4); ";
                ...
                echo "
                 var  selected_domain = realm ;
                 //  var  selection_string ='http://localhost:8002/nbnuserlist.php?dsl_domain=123123&record_status=pending&type=pending&realm =".$realm."';
                 var  selection_string ='http://localhost:8002/status';
                 window.location = selection_string;
        ...
        <table  width =44%    border=0 cellspacing=\"1\" cellpadding=\"1\"  bgcolor =#ffffff  >
            <tr valign=\"top\" bgcolor =#ffffff><td  align=center width=\"40\" nowrap><a href=\"transactions.php?dsl_domain=all\" class=\"text\"></a><br>  <div class=\"dropdown theme-dropdown clearfix\">
                             </td><td  align=center width =20 nowrap><a href=\"nbnuserlist.php?nbn_domain=all\"  class=\"text\"> </a><br>   
             
                    <ul  class=\"button\><li a  href=\"#\" id=\"recordsearch\"   class=\"button\"  role=\"button\" aria-haspopup=\"true\" aria-expanded=\"false\"></i>NBN
                   </ul>
                   
                     <ul class=\"button\" id=\"nbnlist\"  >
                     	 <li id=tranactions ><a href=\"#\"> </a></li> <li id=nbnuserlist >
                     	 <a href=\"#\"><class=button >NBN</button></li>
                        </ul>
                     </a>
                     </div>
    ...
    <center></table></table>
<div style=\"display:none;\" id=\"myDiv\" class=\"animate-bottom container-fluid maxWidth\">
