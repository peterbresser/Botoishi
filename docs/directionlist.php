...
window['marker'+1]. setLatLng([".$endlat.",".$endlon."]).bindPopup(popupText ,{'maxWidth': '140',autoClose: false,  'className': 'stylePopup' ,    offset: [1,1], closeButton: true, closeOnClick : true  });;   
