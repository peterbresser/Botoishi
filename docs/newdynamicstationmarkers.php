...
if(checkmarker=='toilet'){
          window['marker'+1]=new L.Marker([lat,lon],{icon:ToiletIcon} ).addTo(markerGroup);
}
...
window['marker'+1]=new L.Marker([lat,lon], {icon:TobuIcon}).addTo(markerGroup);      
}
...
window['marker'+1]=new L.Marker([lat,lon], {icon:SeibuIcon}).addTo(markerGroup);      
}  
else if(((checkmarker.match(/keisei /g) || []).length)>0){
window['marker'+1]=new L.Marker([lat,lon], {icon:KeiseiIcon}).addTo(markerGroup);      
}  
else if(((checkmarker.match(/meitetsu /g) || []).length)>0){
window['marker'+1]=new L.Marker([lat,lon], {icon:MeitetsuIcon}).addTo(markerGroup);      
} 
else if(((checkmarker.match(/sotetsu /g) || []).length)>0){
window['marker'+1]=new L.Marker([lat,lon], {icon:SotetsuIcon}).addTo(markerGroup);              
}

else if(((checkmarker.match(/mizushima /g) || []).length)>0){
window['marker'+1]=new L.Marker([lat,lon], {icon:MizurinIcon}).addTo(markerGroup);              
} 
else if(((checkmarker.match(/awo line/g) || []).length)>0){
window['marker'+1]=new L.Marker([lat,lon], {icon:KobeElecIcon}).addTo(markerGroup);              
}    
else if(((checkmarker.match(/arima /g) || []).length)>0){
window['marker'+1]=new L.Marker([lat,lon], {icon:KobeElecIcon}).addTo(markerGroup);              
}
else if(((checkmarker.match(/hanshin /g) || []).length)>0){
window['marker'+1]=new L.Marker([lat,lon], {icon:HanshinIcon}).addTo(markerGroup);              
}
else if(((checkmarker.match(/kinokuni /g) || []).length)>0){
window['marker'+1]=new L.Marker([lat,lon], {icon:JRIcon}).addTo(markerGroup);              
}
else if(((checkmarker.match(/hankai /g) || []).length)>0){
window['marker'+1]=new L.Marker([lat,lon], {icon:HankaiIcon}).addTo(markerGroup);              
}
else if(((checkmarker.match(/kintetsu /g) || []).length)>0){

window['marker'+1]=new L.Marker([lat,lon], {icon:KintetsuIcon}).addTo(markerGroup);   
   
}
else if(((checkmarker.match(/seikibashi /g) || []).length)>0){
window['marker'+1]=new L.Marker([lat,lon], {icon:SeikibashiIcon}).addTo(markerGroup);              
}
else if(((checkmarker.match(/kobe expressway/g) || []).length)>0){
window['marker'+1]=new L.Marker([lat,lon], {icon:KobeRapidIcon}).addTo(markerGroup);              
}
else if(((checkmarker.match(/hankyu /g) || []).length)>0){
window['marker'+1]=new L.Marker([lat,lon], {icon:HankyuIcon}).addTo(markerGroup);              
}
else if(((checkmarker.match(/port liner/g) || []).length)>0){
window['marker'+1]=new L.Marker([lat,lon], {icon:KobeNewIcon}).addTo(markerGroup);              
}
else if(((checkmarker.match(/rokko /g) || []).length)>0){
window['marker'+1]=new L.Marker([lat,lon], {icon:KobeNewIcon}).addTo(markerGroup);              
}
else if(((checkmarker.match(/fujikyu /g) || []).length)>0){
window['marker'+1]=new L.Marker([lat,lon], {icon:FujiKyuIcon}).addTo(markerGroup);              
}
else if(((checkmarker.match(/kishu /g) || []).length)>0){
window['marker'+1]=new L.Marker([lat,lon], {icon:KitetsuIcon}).addTo(markerGroup);              
}
else if(((checkmarker.match(/higashiyama /g) || []).length)>0){
window['marker'+1]=new L.Marker([lat,lon], {icon:HigashiyamaIcon}).addTo(markerGroup);              
}
else if(((checkmarker.match(/toyama /g) || []).length)>0){
window['marker'+1]=new L.Marker([lat,lon], {icon:ToyamaCIcon}).addTo(markerGroup);              
} 
else if(((checkmarker.match(/nankai /g) || []).length)>0){

window['marker'+1]=new L.Marker([lat,lon], {icon:NankaiIcon}).addTo(markerGroup);              
}
else if(((checkmarker.match(/oigawa /g) || []).length)>0){
window['marker'+1]=new L.Marker([lat,lon], {icon:OigawaIcon}).addTo(markerGroup);              
}   
...
else if(checkmarker == 'mrdonut'){
window['marker'+1]=new L.Marker([lat,lon], {icon:MrDonutIcon}).addTo(markerGroup);}
else if(checkmarker == 'temple'){
window['marker'+1]=new L.Marker([lat,lon], {icon:TempleIcon}).addTo(markerGroup);}
...
window['marker'+1]=new L.Marker([lat,lon], {icon:HotelIcon}).addTo(markerGroup);}
else if(checkmarker == 'grandvia'){
window['marker'+1]=new L.Marker([lat,lon], {icon:HotelIcon}).addTo(markerGroup);}
else if(checkmarker == 'grantia'){
window['marker'+1]=new L.Marker([lat,lon], {icon:HotelIcon}).addTo(markerGroup);}
else if(checkmarker == 'hoshino'){
window['marker'+1]=new L.Marker([lat,lon], {icon:HotelIcon}).addTo(markerGroup);}
else if(checkmarker == 'onyida'){
window['marker'+1]=new L.Marker([lat,lon], {icon:HotelIcon}).addTo(markerGroup);}

else if(checkmarker == 'minshinku'){
...
else if(checkmarker == 'mystays'){
window['marker'+1]=new L.Marker([lat,lon], {icon:HotelIcon}).addTo(markerGroup); }
 
else if(checkmarker == 'prinehotels'){
window['marker'+1]=new L.Marker([lat,lon], {icon:HotelIcon}).addTo(markerGroup); }

else if(checkmarker == 'superhotel'){
window['marker'+1]=new L.Marker([lat,lon], {icon:HotelIcon}).addTo(markerGroup); }
else if(checkmarker == 'jrhotel'){
window['marker'+1]=new L.Marker([lat,lon], {icon:HotelIcon}).addTo(markerGroup); }
else if(checkmarker == 'apahotels'){
window['marker'+1]=new L.Marker([lat,lon], {icon:HotelIcon}).addTo(markerGroup); }
...
else if(checkmarker=='soupstock'){ 

window['marker'+1]=new L.Marker([lat,lon],{icon:SoupStockIcon} ).addTo(markerGroup); ;
