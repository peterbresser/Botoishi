...
<div class=\"container  container-md  border-0 \">
 <div class=\"row p-2  border-0 \">
    <div class=\"col  text-start p-2  border-0 \"
      <center ><h1><center>Dormy Inn Hotels</h1><br>
...
foreach($locations as $island=>$locationdata){
    ...
    foreach($locationdata as $location){
        $location['location_name'] =ucwords(strtolower($location['location_name']));
        $trplaces=array(",Japan",",japan",", Japan",", japan","japan","Japan",);
                    $location['description']=str_replace($trplaces,"",$location['description'] );
        echo " <td>
