...
where id =".$_GET['id']." and active =1  limit  ");
}
else
...
where type !='station'  and type !='hotel'   and type !='private'  and active =1 and latitude is not NULL limit 0");
while($result=mysqli_fetch_array($query,MYSQLI_ASSOC)){
    if(isset($_POST['closest_station'])) {
        ...
        $stationquery=mysqli_query($japansql ,"select  id, location_name, latitude, longitude, description, web_page, marker  from locations   where type ='station'   and  (latitude between ".$stationendlat." and ".$stationstartlat." ) and (longitude  between ".$stationendlon." and ".$stationstartlon ."  limit  0)");
...
<script language=\"javascript\" src =\"js/heat.js\"</script> 

<body onLoad=\"javascript:init();\">
 <center>     
 <table border =0 width=100% height=95% ><tr><td align =center>  <div id=\"locationmap\" style=\"height: 88vh;\"></div></td></tr></table> <br> 
  ";
